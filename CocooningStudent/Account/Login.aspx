<%@ Page Title="Se connecter" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CocooningStudent.Account.Login" Async="true" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4>Nos annonces n'attendent que toi, connecte toi!</h4>
                    <hr />
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <div class="checkbox">
                                ...
                                <asp:Label runat="server" AssociatedControlID="RememberMe">Enregistrer le mot de passe</asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <p>
                    <asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Disabled">Pas de compte? Inscrit toi ici!</asp:HyperLink>
                </p>
                <p>
