<%@ Page Title="Vérifier le numéro de téléphone" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="CocooningStudent.Account.VerifyPhoneNumber" %>
